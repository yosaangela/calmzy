...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$rt_uno_description = get_bloginfo( 'description', 'display' );
			if ( $rt_uno_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $rt_uno_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
